...
<html>
	...
	<body>
						...
						<div id="tabs_wrapper" class="tabs-content scroll-y x_row">
							...
							<div class="content active" id="rutaTab">
								...
								<div class="boxruta_param boxruta_find">
									...
									<label><input id="keepclickcoord" type="checkbox" checked="checked" > Mantener click para añadir</label>
							...
							*/ ?>
							...
							<div class="content" id="drawZonasTab">
								...
								<p id="zoom_actual" style="font-weight: bold">Total zonas: 0</p>
		...
		<script type="text/javascript" src="https://api.tiles.mapbox.com/mapbox-gl-js/v0.8.1/mapbox-gl.js"></script>
		  -->
