...
// $group_id = '21010552980';
// $url1 = 'https://graph.facebook.com/'.$group_id;
// $des = json_decode(file_get_contents($url1));
 
// echo '<pre>';print_r($des);echo '</pre>';
 
 
// $url2 = "https://graph.facebook.com/{$group_id}/feed?access_token=479992078748280|4de2b6f4a44f16bef9a34b6d50875e02";
// $data = json_decode(file_get_contents($url2));
?>
<style type="text/css">
/*.wrapper {width:300px;border:1px solid #ccc;font-family: "lucida grande",tahoma,verdana,arial,sans-serif;float:left;}
...
?>
 ...
 <?php
	...
	echo '<pre>';
	$zonas = array('8|77|153'=>array('tallermecanicos'=>'1900-01-01'));
	$queryDB->getPoiZonas($zonas,1);
	echo '</pre>';
